function [indices_set] = generate_cross_validation_data(y, unique_y, n_folds)
...
pos_indices_tot = find(strcmp(y, unique_y{1}));
neg_indices_tot = find(strcmp(y, unique_y{2}));
